...
def gen_5gb_ssb_schema(csv_path):
    ...
    schema.add_table(Table('lineorder',
                           ...
                           csv_file_location=csv_path.format('lineorder'), # lineorder_sampled
                           irrelevant_attributes=['lo_commitdate'],
                           table_size=29999795, primary_key=['lo_orderkey', 'lo_linenumber'])) # 0.003333
    ...
    schema.add_table(
        Table('customer',
              ...
              table_size=150000, primary_key=["c_custkey"],
    ...
    schema.add_table(
        Table('part',
              ...
              table_size=600000, primary_key=["p_partkey"],
    ...
    schema.add_table(
        Table('supplier', attributes=['s_suppkey', 's_name', 's_address', 's_city', 's_nation', 's_region', 's_phone'],
              ...
              table_size=10000, primary_key=["s_suppkey"],
...
def gen_500gb_ssb_schema(csv_path):
    ...
    schema.add_table(Table('lineorder',
                           ...
                           csv_file_location=csv_path.format('lineorder'), # lineorder_sampled
                           irrelevant_attributes=['lo_commitdate'],
                           table_size=3000028242, primary_key=['lo_orderkey', 'lo_linenumber'], sample_rate=1.0)) # 0.003333
